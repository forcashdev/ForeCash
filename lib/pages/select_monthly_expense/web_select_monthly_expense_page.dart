...
class _WebSelectMonthlyExpensePageState extends State<WebSelectMonthlyExpensePage> {
  ...
  List<int> datalist = [0, 1, 2,3,4,5,6];
  List expenseNameList = ["Rent", "Electric", "Car Loan", "AMEX", "Auto Insurance", "Cell Phone", "Internet", ];
  List incomeTextList = [];
  List amountTextList = [];
  List apiEveryList = ["15th", "16th", "17th", "18th", "17th", "18th", "17th",];
  List apiPaidList = ["1 Month", "2 Month", "3 Month", "4 Month", "3 Month", "4 Month", "3 Month", ];
