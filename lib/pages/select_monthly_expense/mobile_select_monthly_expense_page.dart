...
class MobileSelectMonthlyExpensePage extends StatefulWidget {
  @override
  _MobileSelectMonthlyExpensePageState createState() => _MobileSelectMonthlyExpensePageState();
}

class _MobileSelectMonthlyExpensePageState extends State<MobileSelectMonthlyExpensePage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Center(child: Container(padding: EdgeInsets.symmetric(horizontal: 30), child: SelectMonthlyExpenseText())),
            SizedBox(
              height: 40,
            ),
            CommonInsertTable(
