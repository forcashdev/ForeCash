...
class WebResetPasswordPage extends StatefulWidget {
  const WebResetPasswordPage({Key key}) : super(key: key);

  @override
  _WebResetPasswordPageState createState() => _WebResetPasswordPageState();
}

class _WebResetPasswordPageState extends State<WebResetPasswordPage> {
  @override
