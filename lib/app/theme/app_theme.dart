...
class AppTheme {
  ...
  static const Color colorBackground = Color(0xFFEDF2F6);
  static const Color colorGrey = Color(0xFF777C90);
  static const Color colorAccent = Color(0xFF12CC8E);
  static const Color colorBlack = Color(0xFF252733);
  static const Color colorGreyDark = Color(0xFF4B506D);
  static const Color colorWhite = Color(0xFFF5F6F7);
  static const Color colorBGWhite = Color(0xFFF2F2F2);
