    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Theme(
            data: ThemeData(dividerColor: Colors.transparent),
            child:
                ExpansionTile(iconColor: Colors.transparent, collapsedIconColor: Colors.transparent, title: getTransactionsCard(visibilityController.transactionsList[index], constraints), children: [
              ListTile(
                title: Row(
                  children: [
                    const Expanded(
