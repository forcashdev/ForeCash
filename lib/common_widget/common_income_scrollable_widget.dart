...
class CommonIncomeScrollableWidget {
  static scrollableWidget({bool? editMode, int? listViewItemCount, BoxConstraints? constraints, Function? onPageChanged, dynamic controller, int? pageViewItemCount, dynamic text}) {
    return Align(
      ...
      child: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return SizedBox(
              height: editMode == true ? Get.height * 0.04 : Get.height * 0.03,
              child: PageView.builder(
                // scrollDirection: Axis.horizontal,
                onPageChanged: (value) {
                  onPageChanged!(value);
